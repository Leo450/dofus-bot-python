from src.lib.resource import RESOURCE_PLANT, RESOURCE_CROP_60, RESOURCE_WATER, RESOURCE_BARLEY, RESOURCE_SAGE, \
    RESOURCE_CLOVER, RESOURCE_MINT
...
config = {
    ...
    'resource_filter': [RESOURCE_WATER, RESOURCE_MINT]
}